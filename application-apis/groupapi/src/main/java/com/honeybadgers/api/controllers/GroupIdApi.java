...
import com.honeybadgers.api.models.GroupModel;
...
public interface GroupIdApi {
     ...
     */
    @ApiOperation(value = "", nickname = "groupIdDelete", notes = "Delete group from Database", response = GroupModel.class, authorizations = {
    ...
    default ResponseEntity<GroupModel> groupIdDelete(@ApiParam(value = "",required=true) @PathVariable("group_Id") Long groupId) {
     ...
     *         or Unauthorized (status code 401)
     */
    @ApiOperation(value = "", nickname = "groupIdGet", notes = "Return group by group_Id from Database", response = GroupModel.class, authorizations = {
        @Authorization(value = "basicAuth")
    }, tags={  })
    @ApiResponses(value = { 
    ...
    default ResponseEntity<GroupModel> groupIdGet(@ApiParam(value = "",required=true) @PathVariable("group_Id") Long groupId) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"mode\" : \"sequential\", \"maxFailures\" : 0, \"paused\" : false, \"parallelismDegree\" : 5, \"force\" : true, \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"priority\" : 80, \"indexNumber\" : 0, \"parentId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"typeFlag\" : \"batch\" }";
     ...
     *         or Unauthorized (status code 401)
     */
    @ApiOperation(value = "", nickname = "groupIdPost", notes = "Update group in Database", response = ResponseModel.class, authorizations = {
        @Authorization(value = "basicAuth")
    }, tags={  })
    @ApiResponses(value = { 
    ...
    default ResponseEntity<ResponseModel> groupIdPost(@ApiParam(value = "",required=true) @PathVariable("group_Id") Long groupId,@ApiParam(value = "group object" ,required=true )  @Valid @RequestBody GroupModel groupModel) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
