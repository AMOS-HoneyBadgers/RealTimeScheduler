...
public class TaskModelActiveTimes {
    @JsonProperty("to")
    private Time to;
    ...
    public TaskModelActiveTimes to(Time to) {
        this.to = to;
        return this;
    }
    ...
    public TaskModelActiveTimes from(Time from) {
        this.from = from;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TaskModelActiveTimes taskModelActiveTimes = (TaskModelActiveTimes) o;
    ...
    public String toString() {
        ...
        sb.append("class TaskModelActiveTimes {\n");
